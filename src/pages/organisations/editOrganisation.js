...
const EditOrganisation = () => {
    ...
    return (
        <Row>
            <Col span={6}>
                <Card title={'Logo'} bordered={false}>
                    {selected.logo ?
                        <Image
                            width={200}
                            src={selected.logo}
            ...
            <Col span={18}>
                <Controls.EditFormGroupsUseParam title="Modifier l'organisation'" fields={fields} bordered={false}
                                                 initialValues={initValue} labelCol={5} wrapperCol={16}
